...
const Carousel = ({
  ...
  //   { tag, style }: viewedComponentProps,
  //   viewedComponentRef
  // ) => {
  //   return createElement(childArray[viewIndex].type, {
  //     ...childArray[viewIndex].props,
  //     style: { flexGrow: 1 },
  //     ref: viewedComponentRef,
  //   });
  ...
  return (
    <div className="shadow-md	max-w-2xl m-0 flex flex-row min-h-96">
      {props.controls && (
        <>
          <button
            onClick={onClickBtn.bind(null, "left")}
            className="border-none hover:bg-sky-400/90 px-3.5"
          >
            &lt;
          </button>
